...
@section('styles')
{{--    No additional styles in this page--}}
    @stop
@section('title1-sub-header','Dashboard')
@section('title2-sub-header','#XRS-45670')
@section('title3-sub-header','Add New')
@section('content')
    ...
    @stop
@section('scripts')
{{--    No additional scripts in this page--}}
    @stop